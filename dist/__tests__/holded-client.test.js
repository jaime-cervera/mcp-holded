...
describe('HoldedClient', () => {
    ...
    beforeEach(async () => {
        ...
        vi.mocked(nodeFetch.default).mockImplementation(mockFetch);
    ...
    describe('get', () => {
        ...
        it('should add query parameters', async () => {
            ...
            expect(mockFetch).toHaveBeenCalledWith('https://api.holded.com/api/invoicing/v1/contacts?page=2&limit=50', expect.any(Object));
        });
    ...
    describe('put', () => {
        it('should make PUT request with body', async () => {
            ...
            expect(mockFetch).toHaveBeenCalledWith('https://api.holded.com/api/invoicing/v1/contacts/123', {
                method: 'PUT',
                headers: {
                    key: 'test-api-key',
                    'Content-Type': 'application/json',
    ...
    describe('uploadFile', () => {
        it('should upload file with FormData', async () => {
            ...
            expect(mockFetch).toHaveBeenCalledWith('https://api.holded.com/api/invoicing/v1/documents/invoice/123/attach', expect.objectContaining({
                method: 'POST',
...
//# sourceMappingURL=holded-client.test.js.map